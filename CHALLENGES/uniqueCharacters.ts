...
* 
*  Is the string in ASCII or Unicode ? --> ASCII (which are 127 characters)
...
*        Anyway, since the for loop is not going to be iterate through more than 127 characters that could be
